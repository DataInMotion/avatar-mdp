...
The Maven group-id is defaulted to **avatar.model-driven-privacy** in *cnf/build.bnd* using the bnd **-groupid** instruction.

## Github - Create Project
- Create a empty [GitHub repository](https://github.com/organizations/geckoprojects-org/repositories/new)
  - Name: `avatar.model-driven-privacy`
...
## Sonarcloud
  ...
  - Analyze new project
  - check `avatar.model-driven-privacy` and `SetUp`
  ...
  - GitHub -> Project-Settings -> Secrets -> [New Repository Secrets](Link: https://github.com/geckoprojects-org/avatar.model-driven-privacy/settings/secrets/actions/new)
    - add `SONAR_TOKEN`
...
git branch -M main
git remote add origin git@github.com:geckoprojects-org/avatar.model-driven-privacy.git
...
- Project -> Settings  -> Branches [add rule](https://github.com/geckoprojects-org/avatar.model-driven-privacy/settings/branch_protection_rules/new)
...
- [Jenkins GitHub-Group](https://devel.data-in-motion.biz/jenkins/job/GH/) should show `avatar.model-driven-privacy`
- [Jenkins avatar.model-driven-privacy branches](https://devel.data-in-motion.biz/jenkins/job/GH/job/avatar.model-driven-privacy/)
